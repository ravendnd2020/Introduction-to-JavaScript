...
*/
//string var  convert to integer  console log
...
*/
  ...
  const miles = function(kms){
    let miles = 0.62137 * kms;
    console.log(miles);
  }
...
function annoyingSong(count){
  console.log(`${count} bottles of beer on the wall ${count-1} left on the wall`);
}
annoyingSong(2);
